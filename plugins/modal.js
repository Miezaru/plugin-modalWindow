...
function _createModal (options) {
    ...
    function modalOptions() {
       ...
       const htmlModalClose = `<span class="modal-close">&times;</span>`
       if (closable) {
           modalTitle.insertAdjacentHTML('afterend', htmlModalClose)
       }
...
*/
    ...
    return Object.assign(modal, {
        ...
        setContent(newContent) {
            $modal.querySelector('[data-content]').innerHTML = newContent
        }
    })
}